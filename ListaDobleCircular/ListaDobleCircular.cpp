...
int main() {
    ...
    while (!salir) {
        std::cout << "Menu:\n"
            ...
            "10. Mover iterador al ultimo elemento\n"
        ...
        case 3:
            ...
            break;
        case 4:
            std::cout << "Ingrese el numero de registro a buscar: ";
            std::cin >> registro;
            lista.buscar(registro);
            break;
        case 5:
            std::cout << "Ingrese el numero de registro a eliminar: ";
            std::cin >> registro;
            lista.eliminar_por_registro(registro);
            break;
        case 6:
            std::cout << "Ingrese el numero de registro a modificar: ";
            std::cin >> registro;
